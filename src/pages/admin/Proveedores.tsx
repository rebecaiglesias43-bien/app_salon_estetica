          ...
          {proveedores.map(p => (
            <div key={p.prv_id} className={`${glassCard} p-5 hover:border-salon-gold/20 transition-all`}>
              ...
              <div className="flex gap-2 mt-3">
                ...
                <button onClick={() => openEdit(p)} className="px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white/50 hover:text-salon-pink hover:bg-white/10 transition-all"><Edit3 size={12} /></button>
                <button onClick={() => setConfirmDelete(p.prv_id)} className="px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white/50 hover:text-red-400 hover:bg-white/10 transition-all"><Trash2 size={12} /></button>
              </div>
              ...
              <div className="flex gap-2 pt-3 border-t border-white/5 mt-3">
                <button onClick={() => openEdit(p)} className="flex items-center gap-1 text-xs text-salon-pink hover:text-salon-lavender"><Edit3 size={12} /> Editar</button>
                <button onClick={() => setConfirmDelete(p.prv_id)} className="flex items-center gap-1 text-xs text-red-400 hover:text-red-500 ml-auto"><Trash2 size={12} /> Eliminar</button>
              </div>
            </div>
          ))}
        </div>
